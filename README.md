...
##### На втором графике нужные функции упадут вниз, возможно их не очень хорошо видно
...
##### Такая же история, как и в предыдущем пункте - только 1s и pm
##### На вторых графиках расположение +- то же, что и в основной части - их просто не видно

## для исходных чтений
![Image alt](https://github.com/switerElly/hse23_hw1/blob/main/img2/Screenshot%20from%202023-10-08%2019-08-09.png)
![Image alt](https://github.com/switerElly/hse23_hw1/blob/main/img2/fastqc_adapter_content_plot%20(3).png)
![Image alt](https://github.com/switerElly/hse23_hw1/blob/main/img2/fastqc_per_sequence_quality_scores_plot%20(3).png)
